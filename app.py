...
st.set_page_config(page_title="Petanca Manager", page_icon="🏆", layout="wide")
st.title("🏆 Registro Avanzado de Partidas de Petanca")

# Sidebar Menu
menu = st.sidebar.selectbox("Menu", ["Agregar Jugadores", "Registrar Partida", "Ver Estadísticas"])
